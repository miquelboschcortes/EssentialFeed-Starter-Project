...
//        
//        URLCache.shared = cache // mutating global state, we need to do it in the appDidFinishLaunching (is the first thing to do in order to our changes poropagate immediately.
//    }
...
//            }
        ...
        default:
            XCTFail("Expected successful feed result, got none instead")
        }
    }
